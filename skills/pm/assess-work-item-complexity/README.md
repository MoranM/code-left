...
- Before deep technical spec work.
- When triaging whether an agent can implement directly or engineering should own execution.
...
`bet-complexity-assessment.md` next to the brief or spec when using Path A (see skill), **or** the org’s own assessment doc when that is what the team uses.
